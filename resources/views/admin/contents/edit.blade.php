@section('title', 'Content ' . $content->title)
        ...
        <div class="container-fluid page__heading-container">
            <div class="page__heading d-flex align-items-center">
                <div class="flex">
                    ...
                    <h1 class="m-0">@lang('Edit Content')</h1>
                </div>
                        ...
                        <form method="POST" action="{{ route('contents.update', $content->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <x-input-info-label>Size: 1280 x 720 | JPG, PNG, JPEG</x-input-info-label>
                                    <input required type="file" name="thumbnail"
                                    accept="image/png, image/jpeg, image/jpg"
                                    data-value-image="{{ $content->thumbnail ? asset('storage/' . $content->thumbnail) : '' }}">
                                ...
                                <div class="col-lg-12" id="box-url">
                                    <div class="form-group">
                                        ...
                                        <x-text-input id="url" name="url" type="text" class="form-control"
                                            required :value="old('url', $content->url)" placeholder="https://youtube.com/watch?v=Ye45Ds33"/>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-text-input id="title" name="title" type="text" class="form-control"
                                            required :value="old('title', $content->title)"/>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-text-input id="subtitle" name="subtitle" type="text" class="form-control"
                                            required :value="old('subtitle', $content->subtitle)"/>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control">{{old('description', $content->description)}}</textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group learns">
                                        <button type="button" class="btn btn-primary p-2 text-uppercase fw-bold"
                                            data-handler="newinput" data-ratio="learns" data-name="name" data-limit-char="250"
                                        ...
                                        @foreach ($content->learns as $item)
                                            <div class="box-inputs-dinamic d-flex align-items-center">
                                                <x-text-input id="learns_{{ $loop->index }}"
                                                    name="learns[{{ $loop->index }}][name]" type="text"
                                                    class="form-control" :value="old('learns.' . $loop->index . '.name', $item->name)"
                                                    placeholder="Insert text here" maxlength="250" />
                                                <x-input-error class="mt-2" :messages="$errors->get('learns.' . $loop->index . '.name')" />
                                                <div class="p-1">
                                            ...
                                            @foreach ($goals as $goal)
                                                <div class="col-lg-4 py-1">
                                                    <input class="check-goals" type="checkbox"
                                                        ...
                                                        id="goal_{{ $goal->id }}"
                                                        value="{{ $goal->id }}"
                                                        @checked($content->goals->contains('id', $goal->id)) />
                                            ...
                                            @foreach ($languages as $language)
                                                <div class="col-lg-6 py-1">
                                                    <input type="checkbox" name="languages[{{ $language->id }}][id]"
                                                        ...
                                                        value="{{ $language->id }}"
                                                        @checked($content->languages->contains('id', $language->id)) />
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="type-content-options" required data-toggle="select">
                                            ...
                                            <option value="1" @selected(old('type', $content->type->value) == 1)>{{ __('Classes') }}</option>
                                            <option value="2" @selected(old('type', $content->type->value) == 2)>{{ __('Course') }}</option>
                                            <option value="3" @selected(old('type', $content->type->value) == 3)>{{ __('Talk') }}</option>
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="cost" id="cost" required data-toggle="select">
                                            <option value="" selected disabled>Select</option>
                                            <option value="1" @selected(old('cost', $content->cost->value) == 1)>{{ __('Free') }}</option>
                                            <option value="2" @selected(old('cost', $content->cost->value) == 2)>{{ __('Paid') }}</option>
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="target" id="target" required data-toggle="select">
                                            <option value="" selected disabled>Select</option>
                                            <option value="1" @selected(old('target', $content->target->value) == 1)>{{ __('Seekers') }}</option>
                                            <option value="2" @selected(old('target', $content->target->value) == 2)>{{ __('Facilitators') }}</option>
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="aimed" id="aimed" required data-toggle="select">
                                            <option value="" selected disabled>Select</option>
                                            <option value="1" @selected(old('aimed', $content->aimed->value) == 1)>{{ __('Men Only') }}</option>
                                            <option value="2" @selected(old('aimed', $content->aimed->value) == 2)>{{ __('Gay Woman') }}</option>
                                            <option value="3" @selected(old('aimed', $content->aimed->value) == 3)>{{ __('Gay Men') }}</option>
                                            <option value="4" @selected(old('aimed', $content->aimed->value) == 4)>{{ __('Couple') }}</option>
                                            <option value="5" @selected(old('aimed', $content->aimed->value) == 5)>{{ __('Women Only') }}</option>
                                            <option value="6" @selected(old('aimed', $content->aimed->value) == 6)>{{ __('Single') }}</option>
                                            <option value="7" @selected(old('aimed', $content->aimed->value) == 7)>{{ __('Anyone') }}</option>
                                            <option value="8" @selected(old('aimed', $content->aimed->value) == 8)>{{ __('Corporate') }}</option>
                                        </select>
                                ...
                                <div class="col-lg-12 d-none" id="box-lessons">
                                    <div class="form-group lessons">
                                        ...
                                        @if(isset($content))
                                            ...
                                            <div class="d-flex remove-extras box-inputs-dinamic">
                                                <div class="w-100" style="padding:10px;border:1px solid #7f9c713d;border-radius:10px;margin:10px 0;position:relative;">
                                                    ...
                                                    <input id="lessons_title_{{$loop->index}}" name="lessons[{{$loop->index}}][title]" type="text" required
                                                        class="form-control form-control-prepended" value="{{old('lessons.' . $loop->index . '.title', $lesson->title)}}"/>

                                                    <label class="text-label pt-2">Subtitle *</label>
                                                    <input id="lessons_subtitle_{{$loop->index}}" name="lessons[{{$loop->index}}][subtitle]" type="text" required
                                                    class="form-control form-control-prepended" value="{{old('lessons.' . $loop->index . '.subtitle', $lesson->subtitle)}}"/>

                                                    <label class="text-label pt-2">Video URL *</label>
                                                    <x-tooltip-info id='infogroup_size' :info="__('Use https:// before the www. link. Example: https://www.youtube.com/yourvideo. Add Vimeo or Youtube link.')" />
                                                    <input id="lessons_url_{{$loop->index}}" name="lessons[{{$loop->index}}][url]" type="text" required
                                                    class="form-control form-control-prepended" value="{{old('lessons.' . $loop->index . '.video_url', $lesson->video_url)}}"/>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox-toggle custom-control-inline mr-1">
                                            <input name="status" type="checkbox" id="checkforContentsPublished" class="custom-control-input" value="1" @checked($content->status)>
                                ...
                                <div class="col-12 py-3">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <label for="terms">I agree with the
                                            ...
                                            <a href="https://stripe.com/en-gb/legal/ssa" target="_blank">{{ __('Stripe Contents Agreement') }}</a>,
