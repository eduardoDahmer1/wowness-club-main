                            ...
                            <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-start">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="file" name="banner" accept="image/png, image/jpeg, image/jpg" />
                                    ...
                                    <div class="col-12">
                                        ...
                                        <x-text-input id="video" name="video" placeholder="https://www.youtube.com/embed/your-video" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-text-input id="flipsnack_embed" name="flipsnack_embed" type="text"
                                                class="form-control" :value="old(
                                                    'flipsnack_embed',
                                                    isset($post) ? $post->flipsnack_embed : '',
                                                )" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox-toggle custom-control-inline mr-1">
                                                <input name="status" type="checkbox" id="checkforPostPublished" class="custom-control-input" value="1">
                                                <label class="custom-control-label" for="checkforPostPublished">..</label>
                                            </div>
                                            <label for="checkforPostPublished" class="mb-0"><small>Published</small></label>
                                    ...
                                    <div>
                                        <x-success-button class="mt-3">{{ __('Create') }}</x-success-button>
