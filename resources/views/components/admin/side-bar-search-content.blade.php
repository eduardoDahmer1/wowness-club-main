...
<form method="GET" class="filter-service" id="search-form">
    <div class="mb-4">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a class="btn_1" href="{{ route('content.search') }}">Content</a>
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-6 check-styles">
                <input type="checkbox" id="classes" name="types[1]" value="1"
                    {{ request('types.1') ? 'checked' : '' }}>
                <label for="classes">{{ __('Classes') }}</label>
            </div>

            <div class="col-lg-6 check-styles">
                <input type="checkbox" id="course" name="types[2]" value="2"
                    {{ request('types.2') ? 'checked' : '' }}>
                <label for="course">{{ __('Course') }}</label>
            </div>

            <div class="col-lg-6 check-styles">
                <input type="checkbox" id="talk" name="types[3]" value="3"
                    {{ request('types.3') ? 'checked' : '' }}>
                <label for="talk">{{ __('Talk') }}</label>
            </div>
        </div>
    ...
    <div class="form-group">
        <h5 class="label-filter">{{__('Cost')}}</h5>
        <div class="row">
            <div class="col-lg-6 check-styles">
                <input type="checkbox" id="free" name="cost[1]" value="1"
                    {{ request('cost.1') ? 'checked' : '' }}>
                <label for="free">{{ __('Free') }}</label>
            </div>

            <div class="col-lg-6 check-styles">
                <input type="checkbox" id="paid" name="cost[2]" value="2"
                    {{ request('cost.2') ? 'checked' : '' }}>
