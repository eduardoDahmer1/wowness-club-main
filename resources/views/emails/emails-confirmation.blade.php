                    ...
                    <table bgcolor="#F8F9FA" width="600px" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr>
                            <td bgcolor="#6E9D72" style="border-radius: 10px 10px 0 0; padding: 40px 0 50px 0;"
                                align="center">
                                <img style="max-width: 180px;" src="https://i.ibb.co/QPk7nF8/logoemail.png"
                                    alt="">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <img style="max-width: 320px; padding-top: 20px;"
                                    src="https://i.ibb.co/hFqLGyr/Woness-foto.png" alt="">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                <h1 style="font-size: 30px; font-weight: normal;">Let's start today!</h1>
                            </td>
                        </tr>

                        <!-- aqui é subtitle -->
                        <tr>
                            <td style="padding: 10px; font-size: 22px; color: #6E9D72; font-weight: normal;"
                                align="center">
                                <span>Confirm your WOWNESS CLUB account</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="font-size: 22px; font-weight: lighter;" align="center">
                                ...
                                <p style="max-width: 460px; text-align: justify;">Welcome to WOWNESS CLUB. We are
                                    excited you are joining us in this journey.</p>
                                <p style="max-width: 460px; text-align: justify;">One more step. Please click the button
                        ...
                        <tr>
                            <td align="center" style="padding: 50px;">
                                   <!--[if mso]>
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $url }}" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="10%" strokecolor="#6E9D72" fillcolor="#6E9D72">
                                    <w:anchorlock/>
                                    <center style="color:#ffffff;font-family:sans-serif;font-size:13px;font-weight:bold;">Confirm Email Address</center>
                                    </v:roundrect>
                                    <![endif]-->
                                    <!--[if !mso]> <!-->
                                     <a style="
                        ...
                        <tr>
                            <td align="center">
                                <p style="max-width: 480px; font-size: 14px; font-weight: lighter;">If you didn’t make
                                    this request, then please ignore this email. If there’s anything we can help with,
                                    please get in touch. Just hit reply!</p>
                            </td>
                        </tr>

                        <!-- aqui é assinatura -->
                        <tr>
                            <td style="padding: 20px; font-size: 15px; color: #6E9D72; font-weight: normal;"
                                align="center">
                        ...
                        <tr>
                            <td style="padding-bottom: 20px; font-size: 14px; color: #364C66;" align="center">
                                ...
                                {{-- <a style="color: #6E9D72; font-size: 15px; font-weight: bold;"
                                    href="#">UNSUBSCRIBE</a> --}}
                            </td>
                        </tr>
