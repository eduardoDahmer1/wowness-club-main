                ...
                <div style="border: 0;" class="card mt-4">
                    <div class="table-responsive bg-white p-4 rounded">
                        <ul class="nav nav-tabs mb-2" style="display: flex;flex-wrap: nowrap;">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{route('orders.indexSeeker', Auth::user()->id)}}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{route('following.indexSeeker', Auth::user()->id)}}">
                                    <h6 style="color: #333333;">Following</h6>
                                </a>
                            </li>
                        </ul>


                        <div id="ListFollowings" class="card mt-4" style="border: 0;"></div>
                    </div>
                </div>
