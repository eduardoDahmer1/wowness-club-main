@section('title', 'Your Content Purchase |')
<x-default-layout>
                ...
                <div style="border: 0;" class="card mt-4">
                    <div class="table-responsive bg-white p-4 rounded">
                        <ul class="nav nav-tabs mb-2" style="display: flex;flex-wrap: nowrap;">
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('orders.indexSeeker', Auth::user()->id)}}">
                                    <h6 style="color: #808080;">Service Orders</h6>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{route('purchases.indexSeeker', Auth::user()->id)}}">
                                    <h6 style="color: #333333;">Content Orders</h6>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <table class="table mb-0 thead-border-top-0 table-striped">
                            <thead>
                                <tr style="color: #A9A9A9;">
                                    ...
                                    <th style="border: none; white-space: nowrap; font-weight: 600;">{{ __('Content Title') }}</th>
                                ...
                                @forelse ($purchases as $purchase)
                                    <tr @class(['bg-tr' => $loop->index % 2 == 0])>
                                        ...
                                        <td style="border: none;">
                                            ...
                                            @else
                                                <a href="{{route('purchases.checkout.index', $purchase->id)}}">
                                        ...
                                        <td style="border: none;">
                                            <small>{{ str($purchase->content->title)->limit(16, '...') }} <a href="{{route('contents.show', $purchase->content->slug)}}" target="_blank"><i class="bi bi-box-arrow-up-right"></i></a></small>
                                        </td>

                                        <td style="border: none;">
                                            {{ $purchase->content->user()->withTrashed()->first()->name }}
                                        </td>
                                        ...
                                        <td style="border: none;">
                                            <div class="d-flex justify-content-end">
                                                <small>@include('front.purchases.partials.modal', [
                                                    'purchaseId' => $purchase->id,
                                                    'purchaseName' => $purchase->title,
                                                ])</small>
                                            </div>
                                        </td>
                                    </tr>
